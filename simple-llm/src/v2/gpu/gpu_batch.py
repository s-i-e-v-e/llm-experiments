"""Command batching - refactored from CommandBatcher class"""
...
# ============================================================================
# COMMAND BATCH STATE (refactored from CommandBatcher class)
# ============================================================================


def create_command_batch(device: object, enable_profiling: bool = False) -> dict:
    """Create command batch state for batched GPU operations"""
    encoder = device.create_command_encoder()
    return {
        "device": device,
        "encoder": encoder,
        "retained_buffers": [],  # Keep references until submit
...
def batch_add_matmul(
    batch_state: dict, A: GPUBuffer, B: GPUBuffer, C: GPUBuffer
) -> dict:
...
def batch_add_gelu(batch_state: dict, input_buf: GPUBuffer, output: GPUBuffer) -> dict:
...
def batch_add_bias_add(
    batch_state: dict, input_buf: GPUBuffer, bias: GPUBuffer, output: GPUBuffer
) -> dict:
...
def batch_add_residual(
    batch_state: dict, input_a: GPUBuffer, input_b: GPUBuffer, output: GPUBuffer
) -> dict:
...
def batch_add_copy(batch_state: dict, source: GPUBuffer, dest: GPUBuffer) -> dict:
...
def batch_add_matmul_backward_a(
    batch_state: dict, grad_C: GPUBuffer, B: GPUBuffer, grad_A: GPUBuffer
) -> dict:
...
def batch_add_matmul_backward_b(
    batch_state: dict, A: GPUBuffer, grad_C: GPUBuffer, grad_B: GPUBuffer
) -> dict:
...
def batch_add_bias_backward(
    batch_state: dict, grad_output: GPUBuffer, grad_bias: GPUBuffer
) -> dict:
...
def batch_submit(batch_state: dict) -> dict:
